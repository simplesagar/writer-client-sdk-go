...
func (s *DownloadTheCustomizedModel) FetchFile(ctx context.Context, customizationID string, modelID string, organizationID *int64, opts ...operations.Option) (*operations.FetchCustomizedModelFileResponse, error) {
	...
	globals := operations.FetchCustomizedModelFileGlobals{
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/llm/organization/{organizationId}/model/{modelId}/customization/{customizationId}/fetch", request, globals)
	if err != nil {

...
func (s *Document) Get(ctx context.Context, documentID int64, teamID int64, organizationID *int64) (*operations.GetDocumentDetailsResponse, error) {
	...
	globals := operations.GetDocumentDetailsGlobals{
		OrganizationID: s.sdkConfiguration.Globals.OrganizationID,
	}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/organization/{organizationId}/team/{teamId}/document/{documentId}", request, globals)
	if err != nil {
...
func (s *Document) List(ctx context.Context, request operations.ListTeamDocumentsRequest) (*operations.ListTeamDocumentsResponse, error) {
	...
	globals := operations.ListTeamDocumentsGlobals{
		OrganizationID: s.sdkConfiguration.Globals.OrganizationID,
	}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/organization/{organizationId}/team/{teamId}/document", request, globals)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
